...
func LoadConfig() *Config {
	...
	AppConfig = &Config{
		...
		SQLiteSourcePath:   getEnv("SQLITE_SOURCE_PATH", "../backend/database/database.sqlite"),
		StorageDir:         getEnv("STORAGE_DIR", "../backend/public/storage"),
		DesktopDistDir:     getEnv("DESKTOP_DIST_DIR", "../backend/public/desktop"),
		MobileDistDir:      getEnv("MOBILE_DIST_DIR", "../backend/public/mobile"),
