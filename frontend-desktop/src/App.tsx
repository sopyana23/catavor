  ...
  return (
    <div style={{
      ...
      <div className="form-group" style={{ marginBottom: 0 }}>
        <label className="form-label" style={{ fontSize: '0.8rem', fontWeight: 700, display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
          <MapPin size={16} style={{ color: 'var(--primary)' }} /> Alamat Lengkap Fisik / Toko *
        </label>
      ...
      <div style={{
        ...
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flex: 1, minWidth: 0 }}>
          <MapPin size={20} style={{ color: enableMaps ? 'var(--primary)' : 'var(--text-muted)', flexShrink: 0 }} />
          <div style={{ display: 'flex', flexDirection: 'column' }}>
            <span style={{ fontSize: '0.88rem', fontWeight: 800, color: 'var(--text-primary)', margin: 0 }}>
      ...
      {enableMaps ? (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', marginTop: '0.2rem' }}>
          ...
          {embedUrl ? (
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <span style={{ fontSize: '0.75rem', fontWeight: 800, color: 'var(--text-primary)', display: 'flex', alignItems: 'center', gap: '0.35rem' }}>
                  <Eye size={14} style={{ color: 'var(--primary)' }} /> Live Preview Tampilan Peta
                </span>
                <a
                  href={directUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  style={{ fontSize: '0.72rem', fontWeight: 700, color: 'var(--primary)', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '0.25rem' }}
                >
                  Buka Peta Utuh <ExternalLink size={12} />
                </a>
              </div>

              <div style={{ width: '100%', height: '220px', borderRadius: '0.5rem', overflow: 'hidden', border: '1px solid var(--border-light)' }}>
                <iframe
            ...
            <div style={{ padding: '0.75rem 1rem', textAlign: 'center', color: 'var(--text-secondary)', fontSize: '0.76rem', fontStyle: 'italic', backgroundColor: 'var(--bg-card-hover)', borderRadius: '0.5rem', border: '1px dashed var(--border-light)' }}>
              Masukkan alamat teks atau link Google Maps di atas untuk melihat preview peta lokasi.
            </div>
          )}
        </div>
      ) : (
        <div style={{ padding: '0.75rem 1rem', textAlign: 'center', color: 'var(--text-secondary)', fontSize: '0.76rem', fontWeight: 500, backgroundColor: 'var(--bg-card-hover)', borderRadius: '0.5rem', border: '1px dashed var(--border-light)' }}>
                      ...
                      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
                        ...
                        {hasLocation && (
                          <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem', gridColumn: 'span 2' }}>
                            <div style={{ display: 'flex', alignItems: 'center', gap: '1rem', padding: '1rem 1.25rem', borderRadius: '0.65rem', border: '1px solid var(--border-light)', backgroundColor: 'var(--bg-card)' }}>
                                ...
                                <div style={{
                                  ...
                                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.5rem' }}>
                                    ...
                                    <span style={{ fontSize: '0.8rem', fontWeight: 800, color: 'var(--text-primary)' }}>
                                      Petunjuk Arah Peta Google Maps
                                    </span>
                                  </div>
