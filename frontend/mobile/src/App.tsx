        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
              {/* Mobile Tab Selector */}
              <div style={{ display: 'flex', backgroundColor: 'rgba(255,255,255,0.06)', borderRadius: '6px', padding: '2px', border: '1px solid var(--border-light)' }}>
                <button
                  type="button"
            ...
            {mobileTab === 'editor' ? (
              ...
              <div style={{
                ...
                {(value || '').trim() ? (
                  <FormattedText
                    text={value}
                    style={{ fontSize: '0.9rem', color: 'var(--text-primary)', lineHeight: '1.65' }}
                  />
                ) : (
                  <div style={{ color: 'var(--text-muted)', fontStyle: 'italic', fontSize: '0.82rem' }}>
                    Belum ada teks yang ditulis. Ketik sesuatu di tab Editor untuk melihat hasil pratinjaunya.
                  </div>
                )}
              </div>
            )}
          ...
          <div style={{
            ...
            <span>💡 <strong>Tips:</strong> Enter untuk baris baru list, Enter 2x untuk keluar dari list.</span>
            ...
            {selectedFauna.description && (
              <div style={{ padding: '1rem', borderBottom: '1px solid var(--border-light)' }}>
                ...
                <FormattedText 
                  ...
                  style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', lineHeight: '1.55' }} 
                />
              </div>
            )}
                  ...
                  {selectedFauna.detailed_info?.shipping_terms && (
                    <div style={{ backgroundColor: 'rgba(255,255,255,0.01)', padding: '0.75rem', borderRadius: '0.4rem', border: '1px solid var(--border-light)' }}>
                      ...
                      <FormattedText 
                        ...
                        style={{ color: 'var(--text-secondary)', fontSize: '0.78rem', lineHeight: '1.45' }} 
                      />
                    </div>
                  )}
