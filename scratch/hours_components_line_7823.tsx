  ...
  return (
    <div style={{ borderRadius: '0.85rem', border: '1px solid var(--border-light)', backgroundColor: 'rgba(255,255,255,0.02)', overflow: 'hidden', transition: 'all 0.2s ease' }}>
      <div 
        ...
        style={{ display: 'flex', alignItems: 'center', gap: '0.85rem', padding: '0.85rem 1rem', cursor: 'pointer', userSelect: 'none' }}
      >
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.15rem', flex: 1, minWidth: 0 }}>
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '0.4rem', flexWrap: 'wrap' }}>
            <span style={{ fontSize: '0.65rem', color: 'var(--text-secondary)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.03em' }}>Jam Operasional</span>
            <span style={{ fontSize: '0.62rem', fontWeight: 800, padding: '0.12rem 0.5rem', borderRadius: '9999px', backgroundColor: statusInfo.badgeBg, color: statusInfo.badgeColor, border: `1px solid ${statusInfo.badgeBorder}` }}>
          ...
          <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '0.4rem' }}>
            ...
            <span style={{ fontSize: '0.7rem', color: 'var(--primary)', fontWeight: 700, flexShrink: 0 }}>
      ...
      {expanded && (
        <div style={{ padding: '0.75rem 0.85rem 0.85rem 0.85rem', borderTop: '1px dashed var(--border-light)', backgroundColor: 'rgba(0,0,0,0.15)', display: 'flex', flexDirection: 'column', gap: '0.35rem' }}>
          <div style={{ fontSize: '0.68rem', color: 'var(--text-secondary)', fontWeight: 700, marginBottom: '0.2rem', display: 'flex', justifyContent: 'space-between' }}>
            <span>JADWAL MINGGUAN ({data.timezone})</span>
            ...
            return (
              ...
              >
                <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
                  ...
                  {isToday && (
                    <span style={{ fontSize: '0.58rem', fontWeight: 800, padding: '0.05rem 0.35rem', borderRadius: '4px', backgroundColor: 'var(--primary)', color: '#fff' }}>
                      Hari Ini
                    </span>
                  )}
                </div>
...
export function OperationalHoursBuilder({ 
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.85rem', padding: '0.85rem', borderRadius: '0.75rem', border: '1px solid var(--border-light)', backgroundColor: 'var(--bg-card)' }}>
      <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '0.5rem', flexWrap: 'wrap' }}>
        <label className="form-label" style={{ margin: 0, fontWeight: 800, fontSize: '0.82rem' }}>📅 Pengaturan Jam Operasional</label>
        <div style={{ display: 'flex', alignItems: 'center', gap: '0.4rem' }}>
          <span style={{ fontSize: '0.7rem', color: 'var(--text-secondary)', fontWeight: 600 }}>Zona:</span>
          <select 
            className="form-input" 
            style={{ width: 'auto', padding: '0.15rem 0.4rem', fontSize: '0.75rem', height: 'auto', borderRadius: '0.4rem' }}
            value={timezone}
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.4rem' }}>
        {[
          ...
          { key: 'weekdays_weekends', label: '💼 Kerja & Akhir Pekan' },
      ...
      {/* MODE 1: EVERYDAY */}
      {mode === 'everyday' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem', padding: '0.75rem', borderRadius: '0.55rem', backgroundColor: 'rgba(255,255,255,0.02)', border: '1px solid var(--border-light)' }}>
          <span style={{ fontSize: '0.72rem', color: 'var(--text-secondary)', fontWeight: 700 }}>Jam Buka &amp; Tutup (Senin - Minggu)</span>
          <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem' }}>
            <div>
              <label className="form-label" style={{ fontSize: '0.68rem' }}>Jam Buka</label>
              <input 
                type="time" 
                className="form-input"
            ...
            <div>
              <label className="form-label" style={{ fontSize: '0.68rem' }}>Jam Tutup</label>
              <input 
                type="time" 
                className="form-input"
                style={{ fontSize: '0.78rem', padding: '0.35rem 0.5rem' }}
          ...
          <div style={{ display: 'flex', gap: '0.3rem', flexWrap: 'wrap', marginTop: '0.1rem' }}>
            {[
              ...
              <button
                ...
                style={{ fontSize: '0.65rem', padding: '0.15rem 0.4rem', borderRadius: '4px', backgroundColor: 'rgba(255,255,255,0.06)', border: '1px solid var(--border-light)', color: 'var(--text-primary)', cursor: 'pointer' }}
              >
                {p.label}
              </button>
            ))}
      ...
      {mode === 'weekdays_weekends' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.65rem' }}>
          <div style={{ padding: '0.75rem', borderRadius: '0.55rem', backgroundColor: 'rgba(255,255,255,0.02)', border: '1px solid var(--border-light)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.4rem' }}>
              <span style={{ fontSize: '0.74rem', color: 'var(--text-primary)', fontWeight: 800 }}>💼 Hari Kerja (Senin-Jumat)</span>
              <button
                type="button"
                onClick={() => {
                ...
                style={{ fontSize: '0.65rem', padding: '0.1rem 0.4rem', borderRadius: '4px', backgroundColor: weekdays.status === 'closed' ? 'rgba(239,68,68,0.2)' : 'rgba(16,185,129,0.2)', color: weekdays.status === 'closed' ? '#ef4444' : '#10b981', border: 'none', fontWeight: 700, cursor: 'pointer' }}
              >
            ...
            {weekdays.status !== 'closed' && (
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem' }}>
                <div>
                  <label className="form-label" style={{ fontSize: '0.68rem' }}>Jam Buka</label>
                  <input type="time" className="form-input" style={{ fontSize: '0.75rem', padding: '0.3rem 0.4rem' }} value={weekdays.open} onChange={(e) => {
                ...
                <div>
                  <label className="form-label" style={{ fontSize: '0.68rem' }}>Jam Tutup</label>
                  <input type="time" className="form-input" style={{ fontSize: '0.75rem', padding: '0.3rem 0.4rem' }} value={weekdays.close} onChange={(e) => {
          ...
          <div style={{ padding: '0.75rem', borderRadius: '0.55rem', backgroundColor: 'rgba(255,255,255,0.02)', border: '1px solid var(--border-light)' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '0.4rem' }}>
              <span style={{ fontSize: '0.74rem', color: 'var(--text-primary)', fontWeight: 800 }}>🎉 Akhir Pekan (Sabtu-Minggu)</span>
              <button
                type="button"
                onClick={() => {
                ...
                style={{ fontSize: '0.65rem', padding: '0.1rem 0.4rem', borderRadius: '4px', backgroundColor: weekends.status === 'closed' ? 'rgba(239,68,68,0.2)' : 'rgba(16,185,129,0.2)', color: weekends.status === 'closed' ? '#ef4444' : '#10b981', border: 'none', fontWeight: 700, cursor: 'pointer' }}
              >
            ...
            {weekends.status !== 'closed' && (
              <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '0.5rem' }}>
                <div>
                  <label className="form-label" style={{ fontSize: '0.68rem' }}>Jam Buka</label>
                  <input type="time" className="form-input" style={{ fontSize: '0.75rem', padding: '0.3rem 0.4rem' }} value={weekends.open} onChange={(e) => {
                ...
                <div>
                  <label className="form-label" style={{ fontSize: '0.68rem' }}>Jam Tutup</label>
                  <input type="time" className="form-input" style={{ fontSize: '0.75rem', padding: '0.3rem 0.4rem' }} value={weekends.close} onChange={(e) => {
      ...
      {mode === 'custom' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.45rem' }}>
          {INDO_DAYS_LIST.map((day) => {
            ...
            return (
              <div key={day} style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0.45rem 0.6rem', borderRadius: '0.45rem', backgroundColor: 'rgba(255,255,255,0.02)', border: '1px solid var(--border-light)', gap: '0.4rem' }}>
                <span style={{ fontSize: '0.74rem', fontWeight: 700, width: '50px', flexShrink: 0 }}>{day}</span>
                
                {isClosed ? (
                  <span style={{ fontSize: '0.7rem', color: '#ef4444', fontWeight: 700, flex: 1 }}>TUTUP</span>
                ) : (
                  <div style={{ display: 'flex', alignItems: 'center', gap: '0.2rem', flex: 1 }}>
                    <input type="time" className="form-input" style={{ padding: '0.15rem 0.3rem', fontSize: '0.7rem' }} value={currentSched.open} onChange={(e) => {
                    ...
                    <input type="time" className="form-input" style={{ padding: '0.15rem 0.3rem', fontSize: '0.7rem' }} value={currentSched.close} onChange={(e) => {
                ...
                <button
                  ...
                  style={{ fontSize: '0.62rem', padding: '0.15rem 0.4rem', borderRadius: '4px', backgroundColor: isClosed ? 'rgba(239,68,68,0.2)' : 'rgba(16,185,129,0.2)', color: isClosed ? '#ef4444' : '#10b981', border: 'none', fontWeight: 700, cursor: 'pointer', flexShrink: 0 }}
                >
                  {isClosed ? 'Buka' : 'Tutup'}
                </button>
              </div>
      ...
      {mode === 'manual' && (
        <div style={{ display: 'flex', flexDirection: 'column', gap: '0.3rem' }}>
          <label className="form-label" style={{ fontSize: '0.7rem' }}>Teks Jam Operasional Manual</label>
          <input 
            type="text"
            className="form-input"
      ...
      {/* LIVE PREVIEW BOX */}
      <div style={{ marginTop: '0.4rem', paddingTop: '0.6rem', borderTop: '1px dashed var(--border-light)' }}>
        <span style={{ fontSize: '0.65rem', color: 'var(--text-secondary)', fontWeight: 700, textTransform: 'uppercase', letterSpacing: '0.03em', display: 'block', marginBottom: '0.4rem' }}>
